...
func DefaultKeys() Keys {
	return Keys{
		...
		ToggleUnhealthy: key.NewBinding(key.WithKeys("u"), key.WithHelp("u", "unhealthy only")),
	}
}

func (k Keys) ShortHelp() []key.Binding {
	return []key.Binding{k.Command, k.SwitchView, k.Filter, k.ToggleUnhealthy, k.Refresh, k.Help, k.Quit}
}
...
func (k Keys) FullHelp() [][]key.Binding {
	return [][]key.Binding{
		...
		{k.Promote, k.Release, k.Approve, k.Reject, k.ToggleUnhealthy},
		{k.Help, k.Quit},
	}
}
